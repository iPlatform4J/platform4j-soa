package com.platform4j.soa.remote.aop;
...
public class RemoteTimeAdvice implements MethodInterceptor {

    private final static Logger logger = LoggerFactory.getLogger(RemoteTimeAdvice.class.getName());
